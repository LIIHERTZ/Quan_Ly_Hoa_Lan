...
public class UpdateOrchidCommandValidator : AbstractValidator<UpdateOrchidCommand>
{
    public UpdateOrchidCommandValidator()
    {
    ...
    private void AddStringListRules(
        System.Linq.Expressions.Expression<Func<UpdateOrchidCommand, IEnumerable<string>>> selector,
        string fieldName)
    {
        RuleFor(selector)
